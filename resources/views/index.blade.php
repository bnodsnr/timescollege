...
<head>
  ...
  <link href="{{asset('assets/nepali-date-picker/css/nepali.datepicker.v3.7.min.css') }}" rel="stylesheet" type="text/css"/>
        ...
        <div class="content-wrapper">
          <div class="row">
            ...
            <div class="col-md-6 col-lg-6 col-xl-3 text-center">
              <h3 class="text-center" style="margin-left:85px;">विद्यालय कर्मचारी अभिलेख</h3>
